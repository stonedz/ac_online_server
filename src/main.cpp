...
//*/
// extern "C" int AMXEXPORT amx_ConsoleInit(AMX *amx);
// extern "C" int AMXEXPORT amx_CoreInit(AMX *amx);
// extern int AMXEXPORT amx_ServerLanguageInit(AMX *amx);
// extern int AMXEXPORT amx_ServerLanguageCleanup(AMX *amx);
//
// AMX *global_amx;
...
// 	err = aux_LoadProgram(&amx, "../src/pawn/serverStartup.amx", NULL);
// 	if (err != AMX_ERR_NONE) {
...
// 	*/
// 	amx_ConsoleInit(&amx);
// 	// Init server language extensions
// 	amx_ServerLanguageInit(&amx);
//
// 	// Init AMX core and also perform native functions checks.
